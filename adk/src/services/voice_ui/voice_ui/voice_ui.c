...
static const audio_router_voice_routing_ind_t routing_ind =
{
    .VoiceRoutingInd = VoiceUi_SuspendAudio,
    .VoiceUnroutedInd = VoiceUi_ResumeAudio,
};
...
bool VoiceUi_Init(Task init_task)
{
    ...
    AudioRouter_RegisterForVoiceRoutingInd(&routing_ind);
