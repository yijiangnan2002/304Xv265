...
} lc3q_enc_sco_iso_error_resilience_level_t;
...
void OperatorsLc3qEncoderScoIsoSetErrorResilience(Operator op, uint16 bit_error_resilience)
{
    lc3q_enc_sco_iso_error_resilience_level_t msg;
    uint16 size_msg = SIZEOF_OPERATOR_MESSAGE(msg);

    msg.msg_id = LC3Q_ENC_SCO_ISO_SET_ERROR_RESILIENCE;
