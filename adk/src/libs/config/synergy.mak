...
ifeq (synergy, $(LIBTYPE))
    ...
    CONFIG_DIRS_FILTER+= connection gatt a2dp hfp avrcp gatt_client gatt_server gatt_manager gatt_ascs_server gatt_aics_client gatt_bass_client gatt_bass_server gatt_cas_server gatt_csis_server gatt_pacs_server gatt_telephone_bearer_server gatt_vcs_client gatt_vcs_server gatt_service_discovery gatt_vocs_client vcp bap_server
