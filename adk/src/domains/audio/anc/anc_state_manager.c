...
{    
    ...
    DEBUG_LOG("ancStateManager_GetNextToggleMode Current mode %d, Next Mode %d", anc_sm_data->current_mode+1, next_mode);
    return next_mode;
}
...
{
    DEBUG_LOG("AncStateManager_SetNextMode cur:%d req:%d", anc_data.current_mode+1, anc_data.requested_mode+1);
