...
static void appKymeraAudioSyncMute(kymeraTaskData *theKymera, bool mute_enable)
{
    ...
    appKymeraSourceSyncSetMonoRouteGain(output, theKymera->output_rate,
                                        appConfigA2dpSyncUnmuteTransitionSamples(), gain_in_db);
}
...
static void appKymeraStopAudioSync(kymeraTaskData *theKymera, Source source)
{
    ...
    appKymeraAudioSyncMute(theKymera, FALSE);
...
static void appKymeraStartChains(kymeraTaskData *theKymera)
{
    ...
    case KYMERA_AUDIO_SYNC_START_SECONDARY_SYNC_UNMUTE:
    {
         ...
         */
        appKymeraAudioSyncMute(theKymera, TRUE);
