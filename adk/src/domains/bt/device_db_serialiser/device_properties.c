...
bool DeviceProperties_SetAudioVolume(device_t device, volume_t volume)
{
    ...
    if (device)
    {
        ...
        DEBUG_LOG_V_VERBOSE("DeviceProperties_SetAudioVolume device %p vol %u audio_vol %u",
                            device, volume.value, audio_volume.value);
    }
...
bool DeviceProperties_SetVoiceVolume(device_t device, volume_t volume)
{
    ...
    if (device)
    {
        ...
        DEBUG_LOG_V_VERBOSE("DeviceProperties_SetVoiceVolume device %p vol %u audio_vol %u",
