...
static void mirrorProfile_StoreAudioConnectParameters(audio_source_t source, const a2dp_connect_parameters_t *params)
{
...
bool MirrorProfile_StoreAudioSourceParameters(audio_source_t source)
{
    ...
    if(AudioSources_GetConnectParameters(source, &source_params))
    {
        ...
        mirrorProfile_StoreAudioConnectParameters(source, audio_params);
