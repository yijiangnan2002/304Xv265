...
{
    DEBUG_LOG("aghfpProfileInstance_HandleInternalCallAccept(%p)", req->instance);
...
{
    DEBUG_LOG("aghfpProfileInstance_HandleInternalCallReject(%p)", req->instance);
...
{
    DEBUG_LOG("aghfpProfileInstance_HandleInternalCallHangup(%p)", req->instance);
