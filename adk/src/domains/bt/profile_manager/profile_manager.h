...
void ProfileManager_SendConnectCfmToTaskList(task_list_t *list, const bdaddr* bd_addr, profile_manager_request_cfm_result_t result, TaskListIterateWithDataRawHandler handler);
