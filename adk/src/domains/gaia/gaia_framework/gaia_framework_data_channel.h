...
{
    GAIA_DATA_TRANSFER_INTERNAL_BASE = INTERNAL_MESSAGE_BASE,
    GAIA_DATA_TRANSFER_INTERNAL_UNKNOWN_RESPONSE = GAIA_DATA_TRANSFER_INTERNAL_BASE,
    ...
    GAIA_DATA_INTERNAL_MESSAGE_END
};
