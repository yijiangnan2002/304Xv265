...
{
    TWSTOP_SECONDARY_GOAL_FIND_ROLE = TWS_TOPOLOGY_SECONDARY_GOALS_MESSAGE_BASE,
...
ASSERT_MESSAGE_GROUP_NOT_OVERFLOWED(TWS_TOPOLOGY_SECONDARY_GOALS, TWSTOP_SECONDARY_GOAL_NOP)
