...
{
    TWSTOP_PRIMARY_GOAL_FIND_ROLE = TWS_TOPOLOGY_PRIMARY_GOALS_MESSAGE_BASE,
...
ASSERT_MESSAGE_GROUP_NOT_OVERFLOWED(TWS_TOPOLOGY_PRIMARY_GOALS, TWSTOP_PRIMARY_GOAL_NOP)
