 ...
 * TODO - Add support for the Crescendo Audio subsystem where the banked
 * interrupts share three processor interrupt lines - one for each priority.
 */
