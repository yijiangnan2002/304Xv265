...
// -----------------------------------------------------------------------------
#define $dmss.snr.Z0_FIELD                  MK1 * 0
#define $dmss.snr.Z1_FIELD                  ADDR_PER_WORD + $dmss.snr.Z0_FIELD
...
#define $dmss.snr.NPROTO_FRAME_FIELD        ADDR_PER_WORD + $dmss.snr.PTR_VARIANT_FIELD
#define $dmss.snr.PTR_LOW_SNR_FLAG_FIELD    ADDR_PER_WORD + $dmss.snr.NPROTO_FRAME_FIELD
#define $dmss.snr.PTR_LOW_INPUT_FLAG_FIELD  ADDR_PER_WORD + $dmss.snr.PTR_LOW_SNR_FLAG_FIELD
#define $dmss.snr.PTR_WIND_FLAG_FIELD       ADDR_PER_WORD + $dmss.snr.PTR_LOW_INPUT_FLAG_FIELD

// Internal fields
#define $dmss.snr.ALFA_FIELD                ADDR_PER_WORD + $dmss.snr.PTR_WIND_FLAG_FIELD
#define $dmss.snr.ALFA_INITIAL_FIELD        ADDR_PER_WORD + $dmss.snr.ALFA_FIELD
#define $dmss.snr.ALFA_FINALSNR_FIELD       ADDR_PER_WORD + $dmss.snr.ALFA_INITIAL_FIELD
#define $dmss.snr.FRAME_INITIAL_FIELD       ADDR_PER_WORD + $dmss.snr.ALFA_FINALSNR_FIELD

#define $dmss.snr.LOW_SNR_FLAG_FIELD        ADDR_PER_WORD + $dmss.snr.FRAME_INITIAL_FIELD
#define $dmss.snr.START_FRAME_FIELD         ADDR_PER_WORD + $dmss.snr.LOW_SNR_FLAG_FIELD
#define $dmss.snr.PEAKSNR_FIELD             ADDR_PER_WORD + $dmss.snr.START_FRAME_FIELD
#define $dmss.snr.PEAKSNR_FINAL_FIELD       ADDR_PER_WORD + $dmss.snr.PEAKSNR_FIELD
#define $dmss.snr.STRUC_SIZE                1 +  ($dmss.snr.PEAKSNR_FINAL_FIELD >> LOG2_ADDR_PER_WORD)


// DMSS SNR User Paramters
#define $dmss.snr.param.SNR_THRES            MK1 * 0
