...
$cvc.init.root:
   ...
   // reset high_wind/hysteresis/3micmode flags
...
$cvc.mc.blend:
   ...
   // ******************************************************************************
   // if((SND.HI_Wind_Flag_Hyst_b.hystFlag||LOW_SNR) && INT_MIC_OK && INT_FIT_OK)
   // ******************************************************************************
   ...
   r2 = M[r7 + $cvc_send.data.low_snr_dobj];                // load low_snr dobj
   r2 = M[r2 + $dmss.snr.LOW_SNR_FLAG_FIELD];               // r2 : load low_snr flag
